 ...
 * <P>
 * Note: entire class by napier @ potatoland.org 
 * (math too complicated, don't know how to use or even what matrices are)
 * I give full credit to napier for this class and thank him for coding this class
 */
public class Matrix
{
	 ...
	 */
	public static Matrix translateMatrix(float dx, float dy, float dz)
	{
		Matrix m = new Matrix();
		m.m03=dx;
		m.m13=dy;
	 ...
	 */
	public static void createBillboardMatrix(FloatBuffer matrix, Vector right, Vector up, Vector look, Vector pos)
	{
